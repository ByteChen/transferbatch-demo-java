...
function renderPage() {
  ...
  document.getElementById('transferSceneId').innerText = TransferScene[batchData.transferSceneId];
}
...
function renderTransferDetail(transferDetail, index) {
  ...
  detailEl.querySelector('#transferAmount').value = transferDetail.transferAmount;
  detailEl.querySelector('#transferRemark').value = transferDetail.transferRemark;
  detailEl.querySelector('#openid').value = transferDetail.openid;
  detailEl.querySelector('#userName').value = transferDetail.userName;
  detailEl.querySelector('#outDetailNo').innerText = transferDetail.outDetailNo;
  detailEl.querySelector('#transferAmount').addEventListener('change', checkInput);
  detailEl.querySelector('#transferRemark').addEventListener('change', checkInput);
...
function renderDeleteBtn() {
  document.querySelectorAll('#transferDetailIndex').forEach((indexEl, index) => {
